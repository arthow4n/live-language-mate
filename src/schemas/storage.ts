...
export const appDataSettingsSchema = z.object({
...
export const localAppDataSchema = z.object({
...
export const storedChatSettingsSchema = z.record(z.string(), chatSettingsSchema);

// Settings context state for localStorage persistence
export const settingsContextStorageSchema = z.object({
...
export type SettingsContextStorage = z.infer<typeof settingsContextStorageSchema>;
